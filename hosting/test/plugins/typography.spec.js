...
const html =
  '<h1>タイトル</h1><p>ここがテキスト</p><p><script>alert("test")</script></p><h2>こちらはタイトルにはならない</h2><p>次のセンテンス。そして<a href="https://www.youtube.com" target="_blank" onClick="beat()">リンク</a>。</p>'
