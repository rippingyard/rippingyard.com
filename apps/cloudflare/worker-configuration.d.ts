/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 060c493a87f184e2621ccad79b601f46)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_OPENAI_ORGANIZATION_ID: string;
		VITE_OPENAI_PROJECT_ID: string;
		VITE_OPENAI_APIKEY: string;
		VITE_OPENAI_ENTITY_ASSISTANT: string;
		VITE_ALGOLIA_APPID: string;
		VITE_ALGOLIA_APIKEY: string;
		VITE_ALGOLIA_APIKEY_ADMIN: string;
		VITE_GOOGLE_APPLICATION_CREDENTIALS: string;
	}
}
